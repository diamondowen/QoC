...
% affiliations
\author{\IEEEauthorblockN{Xiang Chen, Jenq-Neng Hwang, De Meng, Kuan-Hui Lee, Ricardo L. de Queiroz}   \\
...
of Electrical Engineering, University of Washington, Seattle,
WA, 98195 USA. (e-mail: demeng@uw.edu)}% <-this % stops a space
...
\begin{figure}[tb]
\centering{\epsfig{file=Fig/dataRateAdaptation_2800_1.eps,width=3.6in}}
...
\end{figure}
\begin{figure}[tb]
\centering{\includegraphics[width=3.5 in]{Fig/humanDensityChange_1.pdf}}
...
\begin{figure}[tb]
\centering{\epsfig{file=Fig/averagSourceCodingRate_1.eps,width=3.1in}}
...
\begin{figure}[t]
\centering{\epsfig{file=Fig/averageFECRedundancyRate_1.eps,width=3.6in}}
...
\begin{figure}[tb]
\centering{\epsfig{file=Fig/truePositiveProb_dataConstraint_1.eps,width=3.6in}}
...
\begin{figure}[t]
\centering{\epsfig{file=Fig/averageFECRate_1.eps,width=3.6in}}
...
\begin{figure}[tb]
\centering{\epsfig{file=Fig/falseAlarm_dataConstraint_1.eps,width=3.6in}}
...
\begin{figure}[t]
\centering{\epsfig{file=Fig/averagSourceCodingRate_2.eps,width=3.6in}}
...
\begin{figure}[t]
\centering{\epsfig{file=Fig/averageFECRedundancyRate_2.eps,width=3.6in}}
...
\begin{figure}[t]
\centering{\epsfig{file=Fig/averageFECRate_2.eps,width=3.6in}}
...
\begin{figure}[t]
\centering{\epsfig{file=Fig/truePositiveProb_dataConstraint_2.eps,width=3.6in}}
...
\begin{figure}[b]
\centering{\epsfig{file=Fig/falseAlarm_dataConstraint_2.eps,width=3.6in}}
